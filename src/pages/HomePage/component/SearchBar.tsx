  ...
  return (
    <div className="flex flex-col items-center justify-start pt-10 px-4">
      <div className="mb-4 flex flex-col items-start">
        <div className="text-[#2E333B] font-pretendard text-[20px] font-bold">
      ...
      <div className="relative mt-4 w-full max-w-md flex items-center">
        <img src={ico_itpick_logo} alt="Logo Icon" className="w-8 h-8 mr-2" />
        <input 
          type="text" 
          placeholder="김현주 열애설" 
          className="pl-4 pr-12 py-2 w-full rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300" 
        />
